...
<a href="#" data-toggle="modal" data-target="#promo" class="btn btn-info btn-xl btn-between w-100 mgb-1-5x">Промокод <em class="ti ti-arrow-right"></em></a>
                        ...
                        <div class="token-balance">
                            ...
                            <div class="token-balance token-balance-with-icon mobile" style="margin-bottom: 0px;">
                                <div class="token-balance-text">
                                    <h6 class="card-sub-title">Login Name</h6>
  ...
  margin: 0 16px;
    ...
    background-size: 100% 100%;
                        ...
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#dice-game">DICE GAME</a></li>
                        </ul>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="d-sm-flex justify-content-center" style="width:100%;margin:0">
                                                        <span class="badge badge-dim badge-md badge-light" style="min-width:0px!important; padding: 4px 6px;" onclick="var x = ($('#BetSize').val()*2);$('#BetSize').val(parseFloat(x.toFixed(2)));updateProfit()">Увеличить 2х</span>
                                                        <span onclick="$('#BetSize').val(Math.max(($('#BetSize').val()/2).toFixed(2), 1));updateProfit()" class="badge badge-dim badge-md badge-light" style="min-width:0px!important; padding: 4px 6px;margin-left:5px">Половина 2х</span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="d-sm-flex justify-content-center" style="width:100%;margin:0">
                                                        <span class="badge badge-dim badge-md badge-light" style="min-width:0px!important; padding: 4px 6px;" onclick="$('#BetPercent').val(Math.min(($('#BetPercent').val()*2).toFixed(2), 95));updateProfit()">Увеличить 2х</span>
                                                        <span class="badge badge-dim badge-md badge-light" style="min-width:0px!important; padding: 4px 6px;margin-left:5px" onclick="$('#BetPercent').val(Math.max(($('#BetPercent').val()/2).toFixed(2).replace(/.00/g, ''), 1));updateProfit()">Уменьшить 2х</span>
                                                    </div>
                                            ...
                                            <div class="token-info  ">
                                                <div class="heded">
                                                    <ul class="token-info-list text-center desProfit">
                                                        <li class="" style="font-size:64px;margin-top:-47px" id="BetProfit">20</li>
                                                        <span class="card-sub-title card-tyy">Если выиграете вы дополните сумму на</span>
                                                    </ul>
...
<html>
 ...
 <body>
  <form action="handler.php">
   <p><strong>Шанс выпадения рандомный</strong></p>
 </body>
</html>
                        <div class="row">
                ...
                <p class="text-light text-center"><em class="fas fa-info-circle" style="font-size:11px"></em> Вывод от 1 рубля доступен при пополнении 50 Р</p>
            </div>
    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content"><a href="#" class="modal-close" data-dismiss="modal" aria-label="Close"><em class="ti ti-close"></em></a>
            <div class="popup-body">
                ...
                <span class="text-light  d-inline-flex align-items-center"><span class="mb-0"><small id="limitsW">От <b><?=$min_withdraw_sum?></b> до <b>75000</b> рублей за одну выплату</small></span> <span class="badge badge-disabled ml-2">Акция!</span></span>
