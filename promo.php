...
<div class="page-header page-header-kyc"><div class="container"><div class="row justify-content-center"><div class="col-lg-8 col-xl-7 text-center"><h1 class="page-title">Наш официальный домен </h1>
...
<a href="#" data-toggle="modal" data-target="#promo" class="btn btn-info btn-xl btn-between w-100 mgb-1-5">Промокод <em class="ti ti-arrow-right"></em></a>
                    ...
                    <div class="card-innr">
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12 ativemenu">
                                <a class="asff4 font-mid text-dark mfjkg" style="cursor:pointer" onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#game').show(); $(this).addClass('mfjkg'); ">Режимы</a>
                            </div>
                        </div>
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12">
                                <a class="asff4 font-mid text-dark" style="cursor:pointer" onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#profile').show(); $(this).addClass('mfjkg'); ">Настройки</a>
                            </div>
                        </div>
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12">
                                <a class="asff4 font-mid text-dark" style="cursor:pointer" onclick="location.href='<?=$site_support?>'">Поддержка</a>
                        ...
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12">
                                <a class="asff4 font-mid text-dark" style="cursor:pointer" onclick="$('.asff4').removeClass('mfjkg');$('.main-content').hide();$('#ref').show(); $(this).addClass('mfjkg'); ">Реферальная</a>
                            </div>
                        </div>
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12">
                        ...
                        <div class="token-rate-wrap row">
                            <div class="token-rate col-md-6 col-lg-12">
                                <div class="font-mid text-dark" style="cursor:pointer" onclick="exit(); location.href = ''">Выход с аккаунта</div>
                            </div>
                        </div>
  ...
  margin: 0 16px;
    ...
    background-size: 100% 100%;
                        ...
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#classic" style="display:none">Classic </a></li>
                                        ...
                                        <div class="col-md-6 ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 text-center hbetf" style="margin-top:30px ">
                                                    ...
                                                    <span id="hashBet" hid="cca221a4-6a67-430e-acdd-74a33018e3af">
                ...
                <div class="content-area card">
                    <div class="card-innr">
                        ...
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#settings">Вконтакте</a></li>
                        </ul><!-- .nav-tabs-line -->
                        <div class="tab-content" id="profile-details">
                            <div class="tab-pane fade show active" id="personal-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-item input-with-label"><label for="full-name" class="input-item-label">Введите новый пароль</label><input id="resetPass" class="input-bordered" type="password"></div><!-- .input-item -->
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-item input-with-label"><label for="full-name" class="input-item-label">Повторите новый пароль</label><input id="resetPassRepeat" class="input-bordered" type="password"></div><!-- .input-item -->
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center"><button class="btn btn-primary" style=" box-shadow: 0 5px 23px 0 rgba(0, 125, 255, 0.3);" onclick="resetPass()">Сохранить</button>
...
<div class="main-content col-lg-9" id="ref" style="display:none">
                <div class="content-area card">
                    <div class="card-innr">
                        <div class="card-head">
                            <h5 class="card-title card-title-md">Приглашайте друзей и зарабатывайте средства</h5>
                        </div>
                        <div class="card-text">
                            <p>Получайте <strong>30% сразу на баланс</strong> с каждого пополнения реферала.</p>
                        </div>
            ...
            <div class="main-content col-lg-9" id="bonus" style="display:none">
                <div class="card-innr card">
                    <div class="status status-empty">
                        <div class="status-icon"><em class="ti ti-gift"></em></div><span class="status-text text-dark">Получайте каждый день до 150 на свой баланс абсолютно бесплатно</span>
                        <div class="row">
                ...
                <p class="text-light text-center"><em class="fas fa-info-circle" style="font-size:11px"></em> Выплата от 1 до 20 рублей не требует депозита!</p>
            </div>
    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content"><a class="modal-close" data-dismiss="modal" aria-label="Close"><em class="ti ti-close"></em></a>
            <div class="popup-body">
                ...
                <div class="input-item input-with-label"><input class="input-bordered col-6" type="text" id="depositSize" value="100" style=""><span class="input-note">* Комиссии оплачиваются сайтом на праздники</span></div>
    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content"><a href="#" class="modal-close" data-dismiss="modal" aria-label="Close"><em class="ti ti-close"></em></a>
            <div class="popup-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-item input-with-label"><label for="swalllet" class="input-item-label">Выберите систему </label><select autocomplete="off" class="select-bordered select-block select2-hidden-accessible" id="hide_search" onchange="withdrawSelect()" tabindex="-1" aria-hidden="true">
								...
								<optgroup label="Мобильная связь (Казахстан)">
                                    <option value="5">Билайн</option>
                                    <option value="6">Kcell</option>
                                    <option value="7">Altel 4G</option>
                                    <option value="8">Теле 2</option>
                                </optgroup>
                                <optgroup label="Банковские карты (Россия - Казахстан)">
                ...
                <span class="text-light  d-inline-flex align-items-center"><span class="mb-0"><small id="limitsW">От <b><?=$min_withdraw_sum?></b> до <b>50</b> рублей за одну выплату</small></span> <span class="badge badge-disabled ml-2">Комиссия: 0%</span></span>
                ...
                <a id="succes_withdraw" class="btn  btn-block btnSuccess" style="margin-top: 10px;display:none; color:#fff; cursor:default;  margin-bottom:10px;    background: linear-gradient(to right, rgb(10, 203, 144), rgb(43, 222, 109));">Выплата создана, время ожидания от 1 минуты до 12 часов!</a>
                <div class="gaps-2x"></div>
